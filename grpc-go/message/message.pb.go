...
func (x *InputString) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *ResultHash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResultHash) ProtoMessage() {}

func (x *ResultHash) ProtoReflect() protoreflect.Message {
	mi := &file_message_message_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResultHash.ProtoReflect.Descriptor instead.
func (*ResultHash) Descriptor() ([]byte, []int) {
	return file_message_message_proto_rawDescGZIP(), []int{1}
}

func (x *ResultHash) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
var file_message_message_proto_rawDesc = []byte{
	...
	,
...
var file_message_message_proto_goTypes = []interface{}{
	(*InputString)(nil), // 0: main.InputString
	(*ResultHash)(nil),  // 1: main.ResultHash
}
var file_message_message_proto_depIdxs = []int32{
	0, // 0: main.Hasher.Hash:input_type -> main.InputString
	1, // 1: main.Hasher.Hash:output_type -> main.ResultHash
